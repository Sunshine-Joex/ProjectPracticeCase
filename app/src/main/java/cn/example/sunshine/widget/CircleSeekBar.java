...
public class CircleSeekBar extends View {
    ...
    private void initPaints() {
        mDefShadowOffset = getDimen(io.feeeei.circleseekbar.R.dimen.def_shadow_offset);
        /**
         * 圆环画笔
         */
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, io.feeeei.circleseekbar.R.styleable.CircleSeekBar, defStyle, 0);
        mMaxProcess = a.getInt(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_max_process, 100);
        mCurProcess = a.getInt(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_cur_process, 0);
        if (mCurProcess > mMaxProcess) mCurProcess = mMaxProcess;
        mReachedColor = a.getColor(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_reached_color, getColor(io.feeeei.circleseekbar.R.color.def_reached_color));
        mUnreachedColor = a.getColor(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_unreached_color,
                getColor(io.feeeei.circleseekbar.R.color.def_wheel_color));
        mUnreachedWidth = a.getDimension(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_unreached_width,
                getDimen(io.feeeei.circleseekbar.R.dimen.def_wheel_width));
        isHasReachedCornerRound = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_reached_has_corner_round, true);
        mReachedWidth = a.getDimension(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_reached_width, mUnreachedWidth);
        mPointerColor = a.getColor(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_pointer_color, getColor(io.feeeei.circleseekbar.R.color.def_pointer_color));
        mPointerRadius = a.getDimension(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_pointer_radius, mReachedWidth / 2);
        isHasWheelShadow = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_has_wheel_shadow, false);
        if (isHasWheelShadow) {
            mWheelShadowRadius = a.getDimension(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_shadow_radius,
                    getDimen(io.feeeei.circleseekbar.R.dimen.def_shadow_radius));
        }
        isHasPointerShadow = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_has_pointer_shadow, false);
        if (isHasPointerShadow) {
            mPointerShadowRadius = a.getDimension(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_pointer_shadow_radius,
                    getDimen(io.feeeei.circleseekbar.R.dimen.def_shadow_radius));
        }
        isHasCache = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_has_cache, isHasWheelShadow);
        isCanTouch = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_can_touch, true);
        isScrollOneCircle = a.getBoolean(io.feeeei.circleseekbar.R.styleable.CircleSeekBar_wheel_scroll_only_one_circle, false);
